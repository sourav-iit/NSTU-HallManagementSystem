...
if (isset($_POST['form_login'])) {
  ...
  //  $password = md5($password);
    ...
    include('../config.php');
    $num = 0;
    $statement = $db->prepare("select * from tbl_managerlogin where email=? and password=?");
...
<head>
  ...
  <title>Login Manager panel</title>
  <style>
  a:hover{
      ...
      <div class="row" style="margin-left:20px;margin-top:20px;">
        <form class="" name="form_login" action="login.php" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="email" class="form-control"  style="width: 60%;margin-bottom: 20px;" placeholder="Manager email"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="password" name="password" class="form-control"  style="width: 60%;margin-bottom: 20px;" placeholder="Manager password"/>
            </div>
          </div>
