...
;(function(factory) {
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        console.log('onclick="details('+id+')"')
        markup = '<div class="event-container" onclick="details(\''+id+'\')" role="button" data-event-index="'+(event_data.id)+'">';
        ...
        markup += '</p>'
        markup += '<div class=" collapse" id="'+(event_data.id)+'">';
